...
export const AskPage = () => {
  ...
  const [successfullySummitted, setSuccessfullySummitted] =
  ...
  const submitForm = async (data: FormData) => {
    ...
    setSuccessfullySummitted(result ? true : false);
  };

  return (
    <Page title="Ask a question">
      <form onSubmit={handleSubmit(submitForm)}>
        <Fieldset disabled={isSubmitting || successfullySummitted}>
          <FieldContainer>
